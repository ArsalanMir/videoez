...
const FeatureCard = ({
  ...
  >
    ...
    <div className="md:w-1/2">
      <h3 className="text-xl md:text-2xl font-bold mb-4 leading-snug">{title}</h3>
      {subtitle && (
        <p className="text-gray-600 text-sm md:text-base mb-4 leading-relaxed">{subtitle}</p>
      )}
      ...
      <div className="flex flex-wrap gap-4 mt-6">
        <a
          href="#"
          className="inline-flex items-center gap-2 px-6 py-2 text-sm font-medium text-white bg-[#6B3EFF] hover:bg-[#5c33dd] rounded-full shadow-md transition"
        >
          {cta}
        </a>
...
const FeatureSection = () => {
  return (
    <section className="bg-white py-16 px-4 space-y-20">
